    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-white rounded-2xl border border-[#ffd6e0] p-5">
          ...
          <p className="text-2xl font-bold text-[#ff2d78]">{fmt(totalCuotas)}</p>
        </div>
        <div className="bg-white rounded-2xl border border-[#ffd6e0] p-5">
        ...
        <div className="bg-white rounded-2xl border border-[#ffd6e0] p-6 mb-6">
          ...
          <form onSubmit={addDeuda} className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              <button type="submit" className="w-full bg-[#ff2d78] hover:bg-[#e0255f] text-white font-semibold py-2.5 rounded-xl text-sm">
                Registrar deuda
              </button>
            </div>
          </form>
      ...
      <div className="flex flex-col gap-4">
        {deudas.length === 0 && (
          <div className="text-center py-16 bg-white rounded-2xl border border-[#ffd6e0]">
        ...
        {deudas.map((d) => {
          ...
          return (
            <div key={d.id} className="bg-white rounded-2xl border border-[#ffd6e0] p-6">
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div className="text-center bg-[#fff8f9] rounded-xl p-3">
                  <p className="text-xs text-[#1a1a2e]/50 mb-1">Cuota mensual</p>
                  <p className="font-bold text-[#ff2d78]">{fmt(d.cuotaMensual)}</p>
                </div>
                <div className="text-center bg-[#fff8f9] rounded-xl p-3">
